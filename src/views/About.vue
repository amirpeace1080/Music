    ...
    <div class="flex flex-wrap items-center justify-between md:justify-around">
      ...
      <div class="space-x-4">
        <a
          ...
          >Log In</a
        >
        <a class="inline-block text-blue-500 font-semibold text-sm" href="#"
          >Sign Up</a
        >
      </div>
    </div>
      ...
      <header class="flex flex-wrap items-center p-4 md:py-8">
        <div class="md:w-3/12 md:ml-16">
          ...
          <img
            class="
              ...
              p-1
            "
            src="https://lh3.googleusercontent.com/a-/AOh14GhStZaMPUTO7rE7HKqNtwbrwuA7ci3ZrvqyHyT_gw=s288-p-rw-no"
            alt="profile"
          />
        </div>
        ...
        <div class="w-8/12 md:w-7/12 ml-4">
          ...
          <div class="hidden md:block">
            <h1 class="font-semibold">peace_1080</h1>
            <span>
              نصاب خسته ویندوز، متنفر از همه دولت ها، حکومت ها، فیلترها و سیاست
              از هر نوعش. start</span
            >
            <p>
              <a href="http://www.limusic.gigfa.com/">www.limusic.gigfa.com</a>
            </p>
          </div>
        </div>
        ...
        <div class="md:hidden text-sm my-2">
          <h1 class="font-semibold">peace_1080</h1>
          <span>
            نصاب خسته ویندوز، متنفر از همه دولت ها، حکومت ها، فیلترها و سیاست از
            هر نوعش. start</span
          >
          <p>
            <a href="http://www.limusic.gigfa.com/">www.limusic.gigfa.com</a>
